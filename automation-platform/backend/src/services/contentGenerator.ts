...
class ContentGenerator {
   ...
   */
  async curateContent(niche: string): Promise<GeneratedContent> {
    try {
   ...
   */
  private generateTemplateContent(niche: string, platform: string): GeneratedContent {
    const templates = {
      tech: {
        tiktok: {
    ...
    return (
      templates[niche as keyof typeof templates]?.[platform as keyof typeof templates.tech] || {
